...
// can we use "this" keyword with method-- yes

public class EcommApp {
	public EcommApp login(String un, String pwd) {
		System.out.println("login with : " + un + " & " + pwd);
		return this;// "this" keyword is returning current class(EcommApp) object
	// return New EcommApp(); -- we can write like this also
		// here classname is the return type
	}
